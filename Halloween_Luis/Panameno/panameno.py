...
pygame.display.set_caption("Coger al panameño")
...
#Set text
title_text = font.render("Coge al panameño", True, BLACK)
...
game_over_text = font.render("EL PANAMEÑO SE HA ESCAPADO!!!", True, BLACK, ORANGE)
game_over_rect = game_over_text.get_rect()
game_over_rect.center = (WINDOW_WIDTH//2, WINDOW_HEIGHT//2)

continue_text = font.render("Pulsa para volver a intentarlo", True, ORANGE, BLACK)
...
#Set images
background_image = pygame.image.load("carcel.png")
background_rect = background_image.get_rect()
background_rect.topleft = (0, 0)

clown_image = pygame.image.load("panameno.png")
